...
def train():
    print("============================================================================================")
    # def __init__():
    #     self.final_episode = 0
    ####### initialize environment hyperparameters ######
    reword_log = SummaryWriter('./datalogs_car1126')
    env_name = "car1126image_ray_posi_attention_perexperience"
    ...
    while time_step <= max_training_timesteps:
        state = env.reset()
        # print("环境reset之后的初始值", state)
        # state = state[0][0]
        # print("环境reset之后的初始值12345", state.shape)
        ...
        # print("state_ray13333333333333333",state_ray1)
        #雷达数据处理

        #向量与位置信息
        state_posi = torch.from_numpy(state_posi)
        state_posi1 = state_posi
        # print("向量与位置信息",state_posi1)
        #向量与位置信息
        ...
        for t in range(1, max_ep_len+1):
            ...
            # print("idxs111111111111111111111",idxs)
            # print("is_weights 111111111111111111111",is_weights)
            # print("小批量经验333333333333333333333333", mini_batch)
