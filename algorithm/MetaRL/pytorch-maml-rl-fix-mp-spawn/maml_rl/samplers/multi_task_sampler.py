...
class SamplerWorker(mp.Process):
    ...
    def __init__(self,
        ...
        # print("生成环境env_fns",env_fns)
        self.envs = SyncVectorEnv(env_fns,
                                  observation_space=observation_space,
                                  action_space=action_space)
        print("样本中的一起有几个环境",self.envs)
    ...
    def sample_trajectories(self, params=None):
        ...
        with torch.no_grad():
            while not self.envs.dones.all():
                ...
                #这个函数获取观察值，动作，奖励，和batch,怎么看起来是经验池，怎么看是有多个任务，多个任务应该有多个环境？先完成一个任务再完成下一个任务把。
                # print("批量动作值的大小123",actions)
    ...
    def run(self):
        while True:
            ...
            print("输出所有的任务数据2222222222222222222222222",data)
