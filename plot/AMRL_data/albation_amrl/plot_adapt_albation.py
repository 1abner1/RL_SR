...
def draw_line(data_file, label, color, max_min_mean_sm=6, smooth_sm=40):
    ...
    plt.fill_between(data_x,
                     ...
                     alpha=0.1)
plt.figure()
data_files_path = [r'D:\RL_SR\plot\AMRL_data\albation_amrl\run-adant_albation10_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\albation_amrl\run-adant_albation8_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\albation_amrl\run-adant_albation16_carconavoid-tag-Environment_Cumulative Reward.csv'
                   ]
labels = ['AMRL',
          'AMRL_NO_ICM',
          'AMRL_NO_PEP'
...
plt.ylim(0, 1)
plt.xlim(0, 300000)
plt.savefig("adapt albation222.pdf")
plt.show()