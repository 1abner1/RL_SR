...
def curve_plot():
    ...
    data_files_path = [r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid1_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid2_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid8_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid4_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid7_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid6_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid5_dyavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\Static obs\static2\run-ppo_car_static_avoid3_dyavoid-tag-Environment_Cumulative Reward.csv'
                       ]
