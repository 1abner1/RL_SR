...
def curve_plot():
    ...
    data_files_path = [r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid23_staticavoid-tag-Environment_Cumulative Reward .csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid26_staticavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid27_staticavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid28_staticavoid-tag-Environment_Cumulative Reward .csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid32_staticavoid-tag-Environment_Cumulative Reward .csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid30_staticavoid-tag-Environment_Cumulative Reward .csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid31_staticavoid-tag-Environment_Cumulative Reward .csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\run-sac_car_static_avoid29_staticavoid-tag-Environment_Cumulative Reward .csv'
                       ]
    ...
    smooth_sms = [20,20,20,20,20,20,20,20]
    ...
    plt.ylim(0, 1)
    plt.xlim(0, 300000)
    plt.savefig("dynamic obs reward1.pdf")
    plt.show()
