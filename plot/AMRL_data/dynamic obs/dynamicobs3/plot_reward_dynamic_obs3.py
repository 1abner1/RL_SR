...
def curve_plot():
    ...
    data_files_path = [r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_1_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_17_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_3_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_5_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_19_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_8_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_7_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\dynamic obs\dynamicobs3\run-dyobs3_2_carconavoid-tag-Environment_Cumulative Reward.csv'
                       ]
    ...
    plt.ylim(0, 1)
    plt.xlim(0, 600000)
    plt.savefig("dynamic obs3 reward.pdf")
    plt.show()
