...
def draw_line(data_file, label, color, max_min_mean_sm=6, smooth_sm=40):
    ...
    # data_x = data['Step']
    data_x = data['Step'][0:330]
    # data_y = data['Value']
    data_y = data['Value'][0:330]
    data_y = data_y/5
    ...
    plt.fill_between(data_x,
                     ...
                     alpha=0.3)
plt.figure()
data_files_path = [r'D:\RL_SR\plot\AMRL_data\three carmera\run-difcamera_2_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\three carmera\run-difcamera_6_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\AMRL_data\three carmera\run-difcamera_7_carconavoid-tag-Environment_Cumulative Reward.csv'
                   ]
...
plt.ylim(0, 1)
plt.xlim(0, 300000)
plt.savefig("there camera number111.pdf")
plt.show()