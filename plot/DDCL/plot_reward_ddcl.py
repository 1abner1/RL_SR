...
def curve_plot():
    ...
    data_files_path = [r'D:\RL_SR\plot\DDCL\Traindata\run-DDCL2_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\DDCL\Traindata\run-DDCL1_carconavoid-tag-Environment_Cumulative Reward.csv',
                       r'D:\RL_SR\plot\DDCL\Traindata\run-DDCL6_carconavoid-tag-Environment_Cumulative Reward.csv'
                       ]
    ...
    plt.ylim(0,1)
    plt.xlim(0, 300000)
    plt.savefig("Red and Blue car reward value.pdf")
    plt.show()
